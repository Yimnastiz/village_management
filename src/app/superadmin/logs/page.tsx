  ...
  return (
    <div className="space-y-5">
      <div className="border-b border-slate-200 pb-4">
        ...
        <h1 className="mt-1 text-2xl font-semibold tracking-tight text-slate-900">บันทึกกิจกรรมระบบ</h1>
        <p className="mt-1 text-sm text-slate-600">ตรวจสอบกิจกรรมทั้งหมดและบันทึกสำคัญของระบบจากผู้ใช้ หมู่บ้าน และการตั้งค่าระบบ</p>
      </div>

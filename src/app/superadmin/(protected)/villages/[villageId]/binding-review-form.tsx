...
export function BindingReviewForm({ villageName, requestId, proposed, houses, reviewAction }: { villageName: string; requestId: string; proposed: boolean; houses: HouseOption[]; reviewAction: (previousState: BindingReviewActionState, formData: FormData) => Promise<BindingReviewActionState> }) {

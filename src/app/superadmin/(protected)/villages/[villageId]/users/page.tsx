...
export default async function VillageUsersPage({ params, searchParams }: { params: Promise<{ villageId: string }>; searchParams: Promise<{ q?: string; role?: string; status?: string; view?: string; member?: string }> }) {
  ...
  const requestedMemberId = search.member?.trim() || null;

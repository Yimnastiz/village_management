...
import { auditActorRoleLabel } from "@/lib/audit-event";
...
export type AuditLogRow = {
  ...
  resourceLabel: string; target: string | null; villageName: string | null; villageMoo: string | null; referenceId: string | null; detail: AuditDetail & { resourceLabel?: string; village?: string; isSuperAdminIntervention?: boolean };
};

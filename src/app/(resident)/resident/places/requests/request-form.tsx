...
type Props = { mode?: "create" | "update"; targetPlaceId?: string; cancelHref: string; allowedCategories?: string[]; defaultValues?: FormData & { images: PlaceImageView[] } };

export function PlaceRequestForm({ mode = "create", targetPlaceId, cancelHref, allowedCategories, defaultValues }: Props) {

...
export default async function ResidentPlacesPage({ searchParams }: PageProps) {
  ...
  function buildHref(next: { page?: number; sort?: string; q?: string; category?: string }) {
    ...
    return qs ? `/resident/places?${qs}` : "/resident/places";
  }

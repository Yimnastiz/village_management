...
import { newRequestHref } from "@/lib/resident-news-navigation";
...
export function ResidentNewsToolbar({ keyword, source, selectedVisibilities, sort, suggestionTitles, canSubmit, hasResidentAccess }: Props) {
  const newsContext = { from: "news-list" as const, q: keyword || undefined, sort, source, visibility: [...selectedVisibilities].sort().join(",") || undefined };

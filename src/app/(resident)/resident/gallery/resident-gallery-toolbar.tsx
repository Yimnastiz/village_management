...
export function ResidentGalleryToolbar({ keyword, sort, villageName, selectedVisibilities, allowSubmissionsOnly, suggestionTitles, hasResidentAccess }: Props) {

...
interface ResidentDownloadsToolbarProps {
  keyword: string;
...
function buildDownloadsHref(params: {
  ...
  return queryString ? `/resident/downloads?${queryString}` : "/resident/downloads";
}
...
export function ResidentDownloadsToolbar({
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      const targetHref = buildDownloadsHref({

...
export function ResidentAppointmentsToolbar({ keyword, statuses, period, sort, suggestions }: Props) {
  ...
  const count = statuses.length + Number(period !== "all") + Number(sort !== "newest");

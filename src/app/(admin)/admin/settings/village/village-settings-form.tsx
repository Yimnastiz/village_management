...
export function VillageSettingsForm({ village }: { village: Village }) {
  ...
  return <form onSubmit={submit} className="space-y-5">
    ...
    <section className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm sm:p-5">
      <h2 className="text-base font-semibold text-gray-900">ข้อมูลติดต่อและรายละเอียด</h2>
      <p className="mt-1 text-sm text-gray-500">แก้ไขได้เฉพาะข้อมูลสำหรับการติดต่อและคำอธิบายของหมู่บ้าน</p>

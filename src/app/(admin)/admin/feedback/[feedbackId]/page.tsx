...
import { categoryClassName, categoryLabel, feedbackDisplayTitle, statusLabels } from "../feedback-presentation";
...
export default async function AdminFeedbackDetailPage({ params }: { params: Promise<{ feedbackId: string }> }) {
  ...
  const displayTitle = feedbackDisplayTitle(feedback.title, feedback.body);

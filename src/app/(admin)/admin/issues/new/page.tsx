...
import { adminCreateIssueAction } from "../actions";
...
export default function AdminNewIssuePage() {
  ...
  const onSubmit = async (data: FormData) => {
    const result = await adminCreateIssueAction({
      title: data.title,
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center gap-3">
        <Link href="/admin/issues" className="text-gray-400 hover:text-gray-600 transition-colors">

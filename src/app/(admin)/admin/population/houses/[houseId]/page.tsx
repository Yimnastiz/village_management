...
export default async function Page({ params }: { params: Promise<{ houseId: string }> }) {
  ...
  const house = await prisma.house.findFirst({
    ...
    include: {
      persons: { orderBy: [{ firstName: "asc" }, { lastName: "asc" }], select: { id: true, firstName: true, lastName: true, nationalId: true, phone: true, status: true } },

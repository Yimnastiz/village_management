export const SENSITIVE_ACTIONS = [
  ...
  "population.correction.approve",
  "population.correction.reject",
  "population.correction.override_conflict",
...
export const ACTION_POLICIES: Readonly<Record<SensitiveAction, ActionPolicy>> = {
  ...
  "population.correction.approve": ROUTINE_NOTIFY,
  "population.correction.reject": REASON_NOTIFY,
  "population.correction.override_conflict": REASON_NOTIFY,

...
export const residentMenuItems: ResidentMenuItem[] = [
  ...
  { href: "/resident/calendar", label: "ปฏิทิน", icon: Calendar, desktopPriority: 4, mobilePriority: 4 },
  { href: "/resident/binding", label: "ขอผูกเลขบ้าน", icon: FileText, desktopPriority: 5, mobilePriority: 5 },
  { href: "/resident/appointments", label: "นัดหมาย", icon: FileText, desktopPriority: 6, mobilePriority: 6 },
  { href: "/resident/issues", label: "แจ้งปัญหา", icon: AlertCircle, desktopPriority: 7, mobilePriority: 7 },
  ...
  { href: "/resident/downloads", label: "เอกสารดาวน์โหลด", icon: Download, desktopPriority: 10, mobilePriority: 10 },
  { href: "/resident/transparency", label: "ความโปร่งใส", icon: Eye, desktopPriority: 11, mobilePriority: 11 },
  { href: "/resident/contacts", label: "ผู้ติดต่อ", icon: Phone, desktopPriority: 12, mobilePriority: 12 },
  { href: "/resident/household", label: "ข้อมูลครัวเรือน", icon: Users, desktopPriority: 13, mobilePriority: 13 },

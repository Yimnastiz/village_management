...
type NewsCardProps = { href: string; title: string; summary?: string | null; imageUrl?: string | null; isPinned?: boolean; metadata?: React.ReactNode; badge?: React.ReactNode; meta: string };

export function NewsCard({ href, title, summary, imageUrl, isPinned, metadata, badge, meta }: NewsCardProps) {

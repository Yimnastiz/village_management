...
export function RequestViewTabs({ tabs, label }: { tabs: RequestViewTab[]; label: string }) {
  return <nav className="flex w-full flex-wrap gap-1 rounded-lg border border-gray-200 bg-white p-1 sm:w-fit" aria-label={label}>
